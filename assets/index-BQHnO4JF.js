...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vs(e,t,n){return new da({name:`SphericalGaussianBlur`,defines:{SAMPLES:rs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:xs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ys(){return new da({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:xs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bs(){return new da({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xs(),fragmentShader:`
	...
	`}var Ss=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Zi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var Nd=document.createElement(`style`);Nd.textContent=`
  * {
...
`,document.head.appendChild(Nd);var Pd={pumpCasing:{name:`Pump Casing`,type:`Rotating Equipment`,description:`Main centrifugal pump casing`,pressure:`4.2 bar`,flow:`109 m³/h`,temperature:`34 °C`,vibration:`Normal`,wear:`18%`,condition:`Operational`,status:`OPERATIONAL`,maintenance:`Continue normal operation`},electricMotor:{name:`Electric Motor`,type:`Drive Equipment`,description:`Electric motor driving the centrifugal pump`,pressure:`—`,flow:`—`,temperature:`38 °C`,vibration:`Normal`,wear:`12%`,condition:`Good`,status:`OPERATIONAL`,maintenance:`Motor operating within normal parameters`},suctionPipe:{name:`Suction Pipe`,type:`Pipeline`,description:`Pump suction-side pipeline`,pressure:`1.8 bar`,flow:`109 m³/h`,temperature:`32 °C`,vibration:`Low`,wear:`15%`,condition:`Good`,status:`OPERATIONAL`,maintenance:`No immediate maintenance required`},dischargePipe:{name:`Discharge Pipe`,type:`Pipeline`,description:`Pump discharge-side pipeline`,pressure:`4.2 bar`,flow:`109 m³/h`,temperature:`34 °C`,vibration:`Normal`,wear:`22%`,condition:`Good`,status:`OPERATIONAL`,maintenance:`Monitor pressure during operation`},bolts:{name:`Bolts`,type:`Mechanical Fasteners`,description:`Mechanical fastening elements`,pressure:`—`,flow:`—`,temperature:`34 °C`,vibration:`Low`,wear:`10%`,condition:`Good`,status:`OPERATIONAL`,maintenance:`Check torque during scheduled inspection`},dischargeUnion:{name:`Discharge Union`,type:`Pipeline Connection`,description:`Discharge pipeline connection joint`,pressure:`4.2 bar`,flow:`109 m³/h`,temperature:`34 °C`,vibration:`Normal`,wear:`28%`,condition:`Inspection Due`,status:`INSPECTION DUE`,maintenance:`Inspect joint sealing and connection`},outletElbow:{name:`Outlet Discharge Elbow`,type:`Pipeline Connection`,description:`Discharge direction elbow`,pressure:`4.2 bar`,flow:`109 m³/h`,temperature:`34 °C`,vibration:`Low`,wear:`20%`,condition:`Good`,status:`OPERATIONAL`,maintenance:`Check elbow connection during maintenance`},terminalBox:{name:`Terminal Box`,type:`Electrical Component`,description:`Motor electrical connection box`,pressure:`—`,flow:`—`,temperature:`37 °C`,vibration:`Normal`,wear:`8%`,condition:`Good`,status:`OPERATIONAL`,maintenance:`Check electrical terminal tightness`},electricMotorCasing:{name:`Electric Motor Casing`,type:`Drive Equipment`,description:`Protective casing of electric motor`,pressure:`—`,flow:`—`,temperature:`38 °C`,vibration:`Normal`,wear:`14%`,condition:`Good`,status:`OPERATIONAL`,maintenance:`Continue routine motor inspection`}},Fd=document.querySelector(`#componentList`);[[`pumpCasing`,`Pump Casing`,`Rotating Equipment`],[`electricMotor`,`Electric Motor`,`Drive Equipment`],[`suctionPipe`,`Suction Pipe`,`Pipeline`],[`dischargePipe`,`Discharge Pipe`,`Pipeline`],[`bolts`,`Bolts`,`Mechanical Fasteners`],[`dischargeUnion`,`Discharge Union`,`Pipeline Connection`],[`outletElbow`,`Outlet Discharge Elbow`,`Pipeline Connection`],[`terminalBox`,`Terminal Box`,`Electrical Component`],[`electricMotorCasing`,`Electric Motor Casing`,`Drive Equipment`]].forEach(([e,t,n])=>{let r=document.createElement(`button`);r.className=`component-card`,r.dataset.component=e,r.innerHTML=`
    <span class="component-name">${t}</span>
    <span class="component-type">${n}</span>
  `,r.addEventListener(`click`,()=>{$d(e)}),Fd.appendChild(r)});var Id=document.querySelector(`#viewer`),Ld=new Mn;Ld.background=new X(136479);var Rd=new uo(45,Id.clientWidth/Id.clientHeight,.1,5e3);Rd.position.set(4,3,5);var zd=new ou({antialias:!0,alpha:!1});zd.setPixelRatio(Math.min(window.devicePixelRatio,2)),zd.setSize(Id.clientWidth,Id.clientHeight),zd.outputColorSpace=Re,zd.toneMapping=4,zd.toneMappingExposure=1.15,Id.appendChild(zd.domElement);var Bd=new yo(16777215,2.2);Ld.add(Bd);var Vd=new vo(16777215,3.5);Vd.position.set(5,8,6),Ld.add(Vd);var Hd=new vo(9166079,2.5);Hd.position.set(-6,3,4),Ld.add(Hd);var Ud=new vo(16777215,2);Ud.position.set(2,5,-7),Ld.add(Ud);var Wd=new Bo(30,30,479340,406087);Wd.position.y=-1.15,Ld.add(Wd);var Gd=new _u(Rd,zd.domElement);Gd.enableDamping=!0,Gd.dampingFactor=.08,Gd.enablePan=!1,Gd.minDistance=1.2,Gd.maxDistance=30,Gd.target.set(0,0,0);var Kd=null,qd=new Map;new Nu().load(`/models/pump.glb`,e=>{Kd=e.scene,Kd.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,qd.set(e.uuid,e.material),console.log(`GLB OBJECT NAME:`,e.name))}),Ld.add(Kd);let t=new qn().setFromObject(Kd),n=t.getCenter(new K),r=t.getSize(new K);Kd.position.sub(n);let i=Math.max(r.x,r.y,r.z);if(i>0){let e=3.2/i;Kd.scale.setScalar(e)}let a=new qn().setFromObject(Kd).getCenter(new K);Kd.position.sub(a),console.log(`MODEL LOADED SUCCESSFULLY`);let o=[];Kd.traverse(e=>{e.isMesh&&o.push(e.name)}),console.log(`AVAILABLE MESHES:`,o),ef(),$d(`pumpCasing`)},void 0,e=>{console.error(`MODEL LOAD ERROR:`,e)});var Jd={pumpCasing:[`Pump_casing`],electricMotor:[`Electric_motor_`,`Статор_Circle`,`Статор_Circle_1`],suctionPipe:[`Suction_pipe_`],dischargePipe:[`Discharge_pipe`],bolts:[`Bolts_`],dischargeUnion:[`Труба_Circle002`,`Труба_Circle002_1`],outletElbow:[`Труба_Circle003`,`Труба_Circle003_1`],terminalBox:[`Terminal_box_`],electricMotorCasing:[`Труба_Circle002`,`Труба_Circle002_1`,`Статор_Circle`,`Статор_Circle_1`]};function Yd(e){if(!Kd)return[];let t=Jd[e]||[],n=[];return Kd.traverse(e=>{e.isMesh&&t.includes(e.name)&&n.push(e)}),console.log(`Selected component:`,e,`Matched meshes:`,n.map(e=>e.name)),n}function Xd(){Kd&&Kd.traverse(e=>{if(!e.isMesh)return;let t=qd.get(e.uuid);t&&(e.material=t)})}function Zd(e){e.forEach(e=>{let t=qd.get(e.uuid);if(!t)return;let n=t.clone();n.color=new X(12092928),n.emissive=new X(6046464),n.emissiveIntensity=.55,n.metalness=.25,n.roughness=.28,e.material=n})}function Qd(e){if(!e||e.length===0){ef();return}let t=new qn;if(e.forEach(e=>{t.expandByObject(e)}),t.isEmpty()){ef();return}let n=t.getCenter(new K),r=t.getSize(new K),i=Math.max(r.x,r.y,r.z),a=Math.max(i*3.5,2.8),o=new K(1,.7,1).normalize(),s=n.clone().add(o.multiplyScalar(a));Rd.position.copy(s),Gd.target.copy(n),Rd.near=.01,Rd.far=5e3,Rd.updateProjectionMatrix(),Gd.update()}function $d(e){let t=Pd[e];if(!t)return;document.querySelectorAll(`.component-card`).forEach(t=>{t.classList.toggle(`active`,t.dataset.component===e)});let n=document.querySelector(`#engineeringPanel`),r=t.status===`INSPECTION DUE`||t.status===`ATTENTION`;if(n.innerHTML=`
    ...
    <div class="status-box ${r?`warning`:``}">
      <div class="status-caption">CURRENT STATUS</div>
      <div class="status-value">${t.status}</div>
    </div>
  ...
  `,!Kd)return;Xd();let i=Yd(e);i.length>0?(Zd(i),Qd(i)):(console.warn(`No exact mesh found for:`,e,`Showing complete model.`),ef())}function ef(){if(!Kd)return;let e=new qn().setFromObject(Kd),t=e.getCenter(new K),n=e.getSize(new K),r=Math.max(n.x,n.y,n.z),i=Math.max(r*2.8,4);Rd.position.set(t.x+i,t.y+i*.65,t.z+i),Gd.target.copy(t),Gd.update()}document.querySelector(`#resetCamera`).addEventListener(`click`,()=>{Xd(),ef(),$d(`pumpCasing`)}),zd.domElement.addEventListener(`dblclick`,()=>{Xd(),ef(),$d(`pumpCasing`)}),window.addEventListener(`resize`,()=>{let e=Id.clientWidth,t=Id.clientHeight;e<=0||t<=0||(Rd.aspect=e/t,Rd.updateProjectionMatrix(),zd.setSize(e,t))});function tf(){requestAnimationFrame(tf),Gd.update(),zd.render(Ld,Rd)}tf();